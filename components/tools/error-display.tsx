...
function resolveMessage(error: UploadError | string, t: (key: string, params?: Record<string, string | number>) => string): string {
  ...
  const known: Record<string, string> = {
    ...
    'avif-unsupported': 'errors.avifUnsupported',
    'ico-decode-failed': 'errors.icoDecodeFailed',
    'ico-encode-failed': 'errors.processingFailed',
    'dpi-write-failed': 'errors.processingFailed',
