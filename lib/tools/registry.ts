...
const EXPANSION_DEVELOPER_TOOLS: ToolDef[] = [
  ...
  N('bulk-file-renamer', 'developer-tools', 'developer', 'file-pen', ['bulk rename files', 'batch file renamer', 'rename multiple files', 'file renamer', 'اعادة تسمية الملفات', 'تسمية جماعية'], ['duplicate-file-finder', 'hash-generator', 'pdf-extract-images', 'image-compressor'], { maxFileSizeMB: 512, maxFiles: 200, isNew: true }),
  N('duplicate-file-finder', 'developer-tools', 'developer', 'copy', ['find duplicate files', 'duplicate file finder', 'duplicate finder', 'identical files', 'remove duplicates', 'الملفات المكررة', 'البحث عن التكرار'], ['bulk-file-renamer', 'hash-generator', 'remove-duplicate-lines', 'pdf-page-counter'], { maxFileSizeMB: 512, maxFiles: 200, isNew: true }),
];
